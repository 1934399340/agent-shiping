...
// 音乐搜索服务 - 免费音乐素材源
// ============================================
import type { AudioAsset, SearchResult, SearchParams } from '../../types/index.js';
...
// 搜索音乐
async function searchMusic(params: SearchParams): Promise<SearchResult> {
  const query = params.query.toLowerCase();
  const genre = params.genre as typeof MUSIC_GENRES[number] | undefined;
...
// 获取推荐音乐
function getRecommendedMusic(count: number = 5): AudioAsset[] {
